...
// PLACEHOLDER logos — no personal logo supplied. Replace these URLs (or swap back to
// local imports) with your own dark/light monogram, e.g. "../assets/RY-Dark.png".
const LogoDark = "https://placehold.co/128x128/111827/ffffff?text=RY";
const LogoLight = "https://placehold.co/128x128/ffffff/111827?text=RY";
