          ...
          >
            <div className="prose prose-lg dark:prose-invert">
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                Throughout my professional journey, I have contributed to the development of enterprise applications across HRMS, Expense Management, Vendor Management, AI-driven platforms, and robotics. My experience spans the complete software development lifecycle—from designing reusable frontend components and responsive user interfaces to building RESTful APIs, integrating authentication systems, implementing role-based workflows, and deploying production-ready applications. I enjoy solving complex UI challenges, improving application performance, and leveraging modern technologies, including AI integrations, to deliver scalable, maintainable, and user-centric software solutions.
              </p>
            </div>
            ...
            <div className="space-y-3">
              {[
                ...
                // PLACEHOLDER: no X/Twitter on resume — replace with your real handle.
                // { Icon: X, text: "X Profile", href: "https://x.com/raja-yadav-placeholder" },
